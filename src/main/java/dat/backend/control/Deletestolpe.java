...
@WebServlet(name = "Deletestolpe", value = "/Deletestolpe")
public class Deletestolpe extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        int stolpeId = Integer.parseInt(request.getParameter("deletestolpe"));
        try {
            StolpeFacade.deleteStolpe(stolpeId, connectionPool);
